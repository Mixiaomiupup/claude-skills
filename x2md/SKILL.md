...
```bash
cd ~/Documents/obsidian/mixiaomi/raw && python3 ~/.claude/skills/x2md/scripts/x2md.py "<URL>"
```

输出到 `~/Documents/obsidian/mixiaomi/` vault 的 `raw/` 子目录（按 category 一级分类存入 AI/技术/商业/思考），同时复制到剪贴板。
