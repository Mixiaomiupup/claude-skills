...
anyweb --cdp wait selector "textarea" --timeout 15000
anyweb --cdp click "textarea"
anyweb --cdp type "AI programming leaders worth following on Twitter. Include tweet URLs."
anyweb --cdp keys Enter
...
anyweb --cdp open --page grok1 "https://x.com/i/grok?new=true"
anyweb --cdp open --page grok2 "https://x.com/i/grok?new=true" &
anyweb --cdp open --page grok3 "https://x.com/i/grok?new=true" &
anyweb --cdp open --page grok4 "https://x.com/i/grok?new=true" &
wait

# Phase 2: Wait for textareas
anyweb --cdp wait --page grok1 selector "textarea" --timeout 15000 &
# ... (同理 grok2/3/4)
wait

# Phase 3: Submit queries (headless, no focus competition)
(anyweb --cdp click --page grok1 "textarea" && anyweb --cdp type --page grok1 "<Round 1>" && anyweb --cdp keys --page grok1 Enter) &
# ... (同理 grok2/3/4)
wait
