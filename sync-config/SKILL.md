...
| Category | Items |
|----------|-------|
| First-party | 18 skills: article-gen, article-image, analyze, commit, debug, doc-control, explain, feishu, gemini-image, ob, python-style, refactor, remote-repos, review, server, sync-config, test, x2md |
