...
| Category | Items |
|----------|-------|
| First-party | 16 skills: commit, debug, doc-control, explain, feishu, gemini-image, kb, python-style, refactor, remote-repos, review, server, sync-config, test, ucal, x2md |
